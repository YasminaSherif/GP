...
final scaffoldState = GlobalKey<ScaffoldState>();
  ...
  final special = ['نجار', 'حداد', 'كهربائي', 'تعقيم', 'سباك','نقاش','زجاج','محاره','ستائر'];
        ...
        listener: (context, state) {
          if(state is AlreadyRegisteredState){
             ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text('الحساب مسجل بالفعل')));
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      buildTextFormField
                        ...
                        obscureText: false,
                        icon: const Icon(Icons.person_pin, color: Colors.amberAccent,),
                      ),
                      ...
                      buildTextFormField
                        ...
                        obscureText: false,
                        icon: const Icon(Icons.location_on, color: Colors.amberAccent,),
                      ),
                      ...
                      buildTextFormField
                        ...
                        obscureText: false,
                        icon: const Icon(Icons.email_outlined, color: Colors.amberAccent,),
                      ),
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.medical_services, color: Colors.orange,),
                        ),
                        value: value2,
