                ...
                children: [
                  Stack(
                    ...
                    children: [
                      ...
                      if (cubit.workerResponse == null) const Center(child: CircularProgressIndicator()) 
                      else Positioned(
                        left: 110.0,
                        top: 75.0,
                        child: Column(
...
CircleAvatar(
  ...
  child: CircleAvatar(
    ...
    backgroundColor: Colors.grey,
                            ...
                            Text(cubit.workerResponse![0].username,
                              style: const TextStyle(
                                fontWeight: FontWeight.w900,
                              ),
                            ),
                            Text(cubit.workerResponse![0].email,
                              style: const TextStyle(
                                color: Colors.grey,
                                height: 1.0,
                                fontSize: 12.0,
                      ...
                      children: [
                        Padding(
                          ...
                          child: MaterialButton(onPressed: (){
                            navigateWithBack(context, CraftProfileEditing());
                          },
                            child: Row(
